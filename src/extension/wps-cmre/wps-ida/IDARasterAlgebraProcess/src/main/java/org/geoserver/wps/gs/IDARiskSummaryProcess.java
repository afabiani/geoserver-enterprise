...
@DescribeProcess(title = "IDA Risk Summary Process", description = "Provides raster statistics on the selected area.")
public class IDARiskSummaryProcess implements GSProcess {

	protected static final Logger LOGGER = Logging
			.getLogger(IDARiskSummaryProcess.class);
	...
	public static final String DEFAULT_TYPE_NAME = "IDARiskSummaryProcess";

	public IDARiskSummaryProcess(GeoServer geoServer) {
