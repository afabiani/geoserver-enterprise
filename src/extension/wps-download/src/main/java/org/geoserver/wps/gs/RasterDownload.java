...
class RasterDownload {
    ...
    public File execute(
        ...
        try {
            ...
            if(roi!=null){
                final ReferencedEnvelope roiEnvelope= new ReferencedEnvelope(roiInNativeCRS.getEnvelopeInternal(),nativeCRS );
                GridGeometry2D gg2D = new GridGeometry2D(
            ...
            if (roi != null) {
                ...
                if(clip){
                    ...
                    clippedGridCoverage=cropCoverage.execute(
     ...
     * @throws Exception
     */
    private File writeRaster(String mimeType, CoverageInfo coverageInfo,
            GridCoverage2D gridCoverage) throws Exception {
