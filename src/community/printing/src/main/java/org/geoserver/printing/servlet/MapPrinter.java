...
import org.geoserver.printing.config.Config;
...
public class MapPrinter {
     ...
     */
    public RenderingContext print(String spec, OutputStream outFile, String referer) throws DocumentException, UnsupportedEncodingException {
