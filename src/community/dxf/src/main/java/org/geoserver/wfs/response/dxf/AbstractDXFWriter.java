...
public abstract class AbstractDXFWriter implements DXFWriter {
    ...
    // numeric format used for real numbers (especially coordinates)
    ...
    public void setOption(String optionName, Object optionValue) {
        if (optionName.equalsIgnoreCase("geometryasblock")) {
            ...
            setWriteAttribues((Boolean) optionValue);
        } else {
     ...
     */
    private void setWriteAttribues(boolean writeAttributes) {
